...
# Estrategia defensiva
    ...
    if board [0][0] == rival and board [0][1] == rival and board[0][2] == '-':
        return [0,2]

    if board [0][1] == rival and board [0][0] == rival and board[0][2] == '-':
        return [0,2]
    
    if board [1][0] == rival and board [1][1] == rival and board[1][2] == '-':
        return [1,2]

    if board [1][1] == rival and board [1][0] == rival and board[1][2] == '-':
        return [1,2]
    
    if board [2][0] == rival and board [2][1] == rival and board[2][2] == '-':
        return [2,2]

    if board [2][1] == rival and board [2][0] == rival and board[2][2] == '-':
        return [2,2]
    
    if board [0][1] == rival and board [0][2] == rival and board[0][0] == '-':
        return [0,0]

    if board [0][2] == rival and board [0][1] == rival and board[0][0] == '-':
        return [0,0]
    
    if board [0][2] == rival and board [0][0] == rival and board[0][1] == '-':
        return [0,1]
    
    if board [0][0] == rival and board [0][2] == rival and board[0][1] == '-':
        return [0,1]
    
    if board [1][1] == rival and board [1][2] == rival and board[1][0] == '-':
        return [1,0]

    if board [1][2] == rival and board [1][1] == rival and board[1][0] == '-':
        return [1,0]
    
    if board [1][2] == rival and board [1][1] == rival and board[1][0] == '-':
        return [1,0]
    
    if board [2][1] == rival and board [2][2] == rival and board[2][0] == '-':
        return [2,0]

    if board [2][2] == rival and board [2][1] == rival and board[2][0] == '-':
        return [2,0]
    
    if board [2][2] == rival and board [2][0] == rival and board[2][1] == '-':
        return [2,1]

    if board [2][0] == rival and board [2][2] == rival and board[2][1] == '-':
        return [2,1]
    
    if board [0][0] == rival and board [1][0] == rival and board[2][0] == '-':
        return [2,0]

    if board [1][0] == rival and board [0][0] == rival and board[2][0] == '-':
        return [2,0]
    
    if board [1][0] == rival and board [2][0] == rival and board[0][0] == '-':
        return [0,0]

    if board [2][0] == rival and board [1][0] == rival and board[0][0] == '-':
        return [0,0]
    
    if board [2][0] == rival and board [0][0] == rival and board[1][0] == '-':
        return [1,0]
    
    if board [0][1] == rival and board [1][1] == rival and board[2][1] == '-':
        return [2,1]
    
    if board [2][1] == rival and board [0][1] == rival and board[1][1] == '-':
        return [1,1]
    
    if board [1][1] == rival and board [2][1] == rival and board[0][1] == '-':
        return [0,1]
    
    if board [0][2] == rival and board [1][2] == rival and board[2][2] == '-':
        return [2,2]
    
    if board [1][2] == rival and board [0][2] == rival and board[2][2] == '-':
        return [2,2]
    
    if board [2][2] == rival and board [1][2] == rival and board[0][2] == '-':
        return [0,2]
    
    if board [2][0] == rival and board [1][1] == rival and board[0][2] == '-':
        return [0,2]
    
    if board [1][1] == rival and board [0][2] == rival and board[2][0] == '-':
        return [2,0]
    
    if board [0][2] == rival and board [2][0] == rival and board[1][1] == '-':
        return [1,1]
    
    if board [2][2] == rival and board [1][1] == rival and board[0][0] == '-':
        return [0,0]
    
    if board [1][1] == rival and board [0][0] == rival and board[2][2] == '-':
        return [2,2]
    
    if board [0][0] == rival and board [2][2] == rival and board[1][1] == '-':
        return [1,1]
    
    if board [1][0] == rival and board [1][2] == rival and board[1][1] == '-':
        return [1,1]
    ...
    if board [1][1] == rival and board [2][0] == rival and board[0][2] == '-':
        return [0,2] 

    if board [0][2] == rival and board [2][0] == rival and board[1][1] == '-':
        return [1,1] 

    if board [0][2] == rival and board [1][1] == rival and board[2][0] == '-':
        return [2,0] 

    if board [1][0] == rival and board [1][1] == rival and board[1][2] == '-':
        return [1,2]

    if board [2][1] == rival and board [1][1] == rival and board[0][1] == '-':
        return [0,1]
